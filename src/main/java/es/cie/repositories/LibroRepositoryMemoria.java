...
public class LibroRepositoryMemoria implements LibroRepository {
	...
	static {
		...
		lista.add(new Libro("4","java jbdc","ana",100));
		lista.add(new Libro("5","java","maria",200));
	...
	public List<Libro> buscarPorTitulo(String titulo){
		//este metodo genera una nueva lista que contiene los libros//
		//cuyo titulo sea similar al que pasamos//
		List<Libro> listaNueva=new ArrayList<Libro>();
		for(Libro l:lista) {
			String tituloLibro=l.getTitulo();
			//este es el titulo del libro//
